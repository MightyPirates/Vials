                ...
                if (fluidHandlerItem != null) {
                    ...
                    if (tankProperties.length != 0) {
                        ...
                        if (contents != null && contents.amount > 0) {
                            FluidUtil.tryEmptyContainerAndStow(stack, fluidHandlerDrain, playerInventory, tankProperties[0].getCapacity(), player);

                        } else {
                            FluidUtil.tryFillContainerAndStow(stack, fluidHandlerDrain, playerInventory, tankProperties[0].getCapacity(), player);
                        }
                        //workaround for 1.10. Because forge!
                        if (world.isRemote)
